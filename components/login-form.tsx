  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground">Inicia sesión con tu cuenta de ScaleMote</p>
              </div>

              <div className="gap-2 grid">
                <Label htmlFor="email">Email</Label>
                <Input id="email" type="email" placeholder="micorreo@ejemplo.com" required />
              </div>

              <div className="gap-2 grid">
                <div className="flex items-center">
                  <Label htmlFor="password">Contraseña</Label>
                  <Link href="#" className="ml-auto text-gray-500 text-xs underline-offset-2 hover:underline">
              ...
              <Link href="/home" className={cn(buttonVariants({ variant: "default" }), "w-full")}>
                Iniciar sesión
              </Link>

              <div className="relative after:top-1/2 after:z-0 after:absolute after:inset-0 after:flex after:items-center after:border-t after:border-border text-center text-sm">
      ...
      <div className="text-balance text-center text-muted-foreground text-xs hover:[&_a]:text-primary [&_a]:underline [&_a]:underline-offset-4">
        Al continuar, aceptas nuestros <Link href="#">Términos de Servicio</Link> y{" "}
